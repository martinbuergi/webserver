...
import com.buergi.webserver.http.impl.HttpRequestl10Impl;
...
public class HttpRequestServiceImpl implements HttpRequestService {
	...
	public HttpRequest createRequestInstance(String version, String method, String path, Map<String, String> parameterMap){
		if (version.equals("HTTP/1.1"))
			return new HttpRequest11Impl(version, method, path, parameterMap, httpResponseService);
		
		if (version.equals("HTTP/1.0") || version.equals("HTTP/0.9"))
			return new HttpRequestl10Impl(version, method, path, parameterMap, httpResponseService);
