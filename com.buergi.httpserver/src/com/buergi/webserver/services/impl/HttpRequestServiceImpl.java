...
import com.buergi.webserver.http.impl.HttpProtocol10;
import com.buergi.webserver.http.impl.HttpProtocol11;
...
public class HttpRequestServiceImpl implements HttpRequestService {
	...
	public HttpRequest createRequestInstance(String version, String method, String path, Map<String, String> parameterMap){
		if (version.equals("HTTP/1.1"))
			return new HttpProtocol11(version, method, path, parameterMap, httpResponseService);
		
		if (version.equals("HTTP/1.0") || version.equals("HTTP/0.9"))
			return new HttpProtocol10(version, method, path, parameterMap, httpResponseService);
